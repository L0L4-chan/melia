export class Commun{
    elements = {
        ...
        //view and booking
        hotel : () => cy.get( '#__next > div > div > main > div:nth-child(3) > div > div.c-section___1kLue > div > div > div > div > div > div:nth-child(1) > div > div.info-wrapper___34DSy > div > div > div.b-wrapper___3CcRc > div > div > div:nth-child(1) > div > div > span',{ timeout: 15000 }),
        getHotel : () =>  cy.get("#__next > div > div > main > div:nth-child(3) > div > div.c-section___1kLue > div > div > div > div > div > div:nth-child(2) > div > div.info-wrapper___34DSy > div > div > div.actions-wrapper___3x3wS > div > div > div > div:nth-child(2) > button", { timeout: 15000 }),            
        //booking
        ...
        addextras : () => cy.get( '#extra-services > div > div > div > div > div > div > div.cell.expandables-wrapper___2P3nj > div > div.body___AjL7f > div > div:nth-child(2) > div > div > div.plus___2yynh > svg',{ timeout: 15000 }), 
        acceptextras : () => cy.get('#__next > div > div > main > div.c-modal___2lrxj > div.container___1q-Ao > div > div > div > div > div.actions___zTbmZ > div > div > div.c-block___29w0l > div > button:nth-child(2)',{ timeout: 15000 }),
        accessform : () => cy.get( '#__next > div > div > main > div.b-wrapper___3CcRc > div > div.content-body___jxs7r > div:nth-child(3) > div > button:nth-child(2)',{ timeout: 15000 }),
        ...
        tarifa: ()=> cy.get('[data-size="4"] > .c-button___2XZmD', { timeout: 15000 }),


        refuseextras : () => cy.get('#__next > div > div > main > div.c-modal___2lrxj > div.container___1q-Ao > div > div > div > div > div.actions___zTbmZ > div > div > div.c-block___29w0l > div > button:nth-child(1)',{ timeout: 15000 }),
        advance:() =>   cy.get("#__next > div > div > main > div.b-wrapper___3CcRc > div > div.content-aside___3QqwC > div > div:nth-child(4) > div.c-block___29w0l > div > div:nth-child(1) > h5",{ timeout: 15000 }),
        // booking info
